...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span>Input Rule Certainty Factor Pestisida per Penyakit</span>
    ...
    <div class="card-body">
        ...
        <div class="alert alert-warning mb-0">Lengkapi data penyakit dan pestisida sebelum mengisi aturan CF.</div>
        ...
        <div class="alert alert-info d-flex justify-content-between align-items-center">
            <div>
                Pakar mengisi nilai <strong>MB</strong> dan <strong>MD</strong> untuk hubungan antara penyakit dan pestisida.
