...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span>Input Rule Certainty Factor Pestisida per Gejala</span>
    ...
    <div class="card-body">
        ...
        <div class="alert alert-info d-flex justify-content-between align-items-center">
            <div>
                Gunakan nilai <strong>MB</strong> dan <strong>MD</strong> dari pakar untuk menentukan kekuatan rule antara gejala dan pestisida.
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" min="0" max="1" step="0.001"
                                        ...
                                        data-cf="{{ $gejalaItem->id }}-{{ $pestisidaItem->id }}">
                                </td>
                                <td>
                                    <input type="number" min="0" max="1" step="0.001"
                                ...
                                <td class="fw-semibold cf-result" data-cf="{{ $gejalaItem->id }}-{{ $pestisidaItem->id }}">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-outline-danger reset-btn" 
                                            ...
                                            data-target="{{ $gejalaItem->id }}-{{ $pestisidaItem->id }}">
            ...
            <div class="position-fixed bottom-0 start-0 w-100 bg-white border-top p-3 shadow-lg d-none" id="stickyFooter">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <button type="submit" class="btn btn-spk btn-lg">Simpan Aturan CF Pestisida</button>
                        </div>
                        <div class="col">
