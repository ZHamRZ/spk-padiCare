        ...
        <form action="{{ route('admin.pupuk.update', $pupuk) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" min="0" step="0.01" name="harga_per_kg" value="{{ old('harga_per_kg', $pupuk->harga_per_kg) }}" class="form-control @error('harga_per_kg') is-invalid @enderror">
                    @error('harga_per_kg')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <label class="form-label">Satuan</label>
                    <input type="text" name="satuan" value="{{ old('satuan', $pupuk->satuan) }}" class="form-control @error('satuan') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="takaran" value="{{ old('takaran', $pupuk->takaran) }}" class="form-control @error('takaran') is-invalid @enderror">
